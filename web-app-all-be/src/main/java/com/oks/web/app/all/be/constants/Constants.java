package com.oks.web.app.all.be.constants;

public interface Constants {
	String INTERNAL_SERVER_ERROR_SAVE = "Internal Server Error: Data Not Saved";
	String INTERNAL_SERVER_ERROR_FIND = "Internal Server Error: Data Not Exist";
